...
- Baseline is a CPU pass-through reference (correctness only), so no GPU timing ratio is reported. For bandwidth comparisons against a sync copy, see sources/experience/hw-probes/async-copy.md.
