...
measured_on:
  ...
  driver: 570.124.06
artifacts:
  code: 80-experience/api-probes/artifacts/__ldcv_probe.cu
...
// 80-experience/api-probes/artifacts/__ldcv_probe.cu.
```

Full source: `80-experience/api-probes/artifacts/__ldcv_probe.cu`.
...
|---|---|---|---|---|---|---|---|---|---|
| 67108864 | fp32 | 0.204320 | 0.204096 | 0.205632 | plain-global-load | 0.204096 | 0.9989 | unknown | `nvcc -arch=sm_90a -O3 -std=c++17 -o /tmp/p knowledge/80-experience/api-probes/artifacts/__ldcv_probe.cu && /tmp/p` |
