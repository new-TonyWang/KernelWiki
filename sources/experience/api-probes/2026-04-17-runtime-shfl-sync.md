...
measured_on:
  ...
  driver: 570.124.06
artifacts:
  code: 80-experience/api-probes/artifacts/__shfl_sync_probe.cu
...
conclusions:
  ...
  ratio: null
back_filled_into:
- 10-api-raw/runtime/__shfl_sync.md
open_questions:
...
|---|---|---|---|---|---|---|---|---|---|
| 1024 | fp32 | 0.005248 | 0.005056 | 0.005600 | cpu-reference-permutation | N/A | N/A | unknown | `nvcc -arch=sm_90a -O3 -std=c++17 -o /tmp/p knowledge/80-experience/api-probes/artifacts/__shfl_sync_probe.cu && /tmp/p` |
