...
measured_on:
  ...
  driver: 570.124.06
artifacts:
  code: 80-experience/api-probes/artifacts/__ldca_probe.cu
...
// 80-experience/api-probes/artifacts/__ldca_probe.cu.
```

Full source: `80-experience/api-probes/artifacts/__ldca_probe.cu`.
...
|---|---|---|---|---|---|---|---|---|---|
| 67108864 | fp32 | 0.204288 | 0.203936 | 0.205280 | plain-global-load | 0.204256 | 0.9998 | unknown | `nvcc -arch=sm_90a -O3 -std=c++17 -o /tmp/p knowledge/80-experience/api-probes/artifacts/__ldca_probe.cu && /tmp/p` |
