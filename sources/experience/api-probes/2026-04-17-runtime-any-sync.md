...
measured_on:
  ...
  driver: 570.124.06
artifacts:
  code: artifacts/experience/api-probes/artifacts/__any_sync_probe.cu
...
|---|---|---|---|---|---|---|---|---|---|
| 1024 | int32 | 0.005024 | 0.004832 | 0.005376 | cpu-or-reduction-check | N/A | N/A | unknown | `nvcc -arch=sm_90a -O3 -std=c++17 -o /tmp/p artifacts/experience/api-probes/artifacts/__any_sync_probe.cu && /tmp/p` |
