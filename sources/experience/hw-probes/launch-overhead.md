...
measured_on:
  ...
  driver: 570.124.06
artifacts:
  code: sources/experience/hw-probes/launch-overhead/artifacts/launch_overhead_probe.cu
  build: sources/experience/hw-probes/launch-overhead/artifacts/build.sh
  introspection: sources/experience/hw-probes/launch-overhead/artifacts/device.json
  profile: ''
