---
id: hw-ascend910-9362
title: "Ascend910_9362 NPU 硬件规格"
type: hardware
vendor: ascend
architectures:
- ascend910b
...
aliases: []
---
# Ascend910_9362 NPU 硬件规格

> SoC_version: Ascend910_9362 | AIC_version: AIC-C-220 | Cube/Vector 分离架构

## 芯片配置

- 20 个 AI Core，每个包含: 2 个 VEC + 1 个 CUBE（Cube/Vector 分离）
- 整个芯片: 40 VEC, 20 CUBE
- Cube 频率: 1500 MHz
- AI CPU: 6 个
...
| 存储层级 | 容量 | 共享范围 | 对齐 | 说明 |
|---------|------|---------|------|------|
| GM | 32GB | 全设备 | - | HBM 设备主存储 |
| L2 Cache | 168MB | 20 个 AI Core | - | 自动缓存，64 页 |
...
- **支持精度**: FP16×FP16→FP16/FP32, INT8×INT8→INT32, INT4/INT2 量化
- **工作流程**:
  1. L0A ← 左矩阵 A (m0×k0)
  2. L0B ← 右矩阵 B (k0×n0)
  3. CUBE 执行矩阵乘: C = A × B
