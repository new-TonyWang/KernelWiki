---
id: api-ascendc-atlasascendc_api_07_0067
title: "AscendC Compare（结果存入寄存器）"
type: api-definition
vendor: ascend
func_name: "Compare（结果存入寄存器）"
namespace: ascendc
header: kernel_operator.h
signature: "see body"
source:
- path: "https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/API/ascendcopapi/atlasascendc_api_07_0067.html"
  anchor: API
architectures:
- ascend910b
languages:
