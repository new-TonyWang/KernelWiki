...
probed_by: 80-experience/api-probes/2026-04-17-runtime-ldcs.md
id: api-__ldcs
type: api-definition
vendor: nvidia
title: __Ldcs
...
See the probe record at [80-experience/api-probes/2026-04-17-runtime-ldcs.md](../../80-experience/api-probes/2026-04-17-runtime-ldcs.md) for a complete end-to-end example, kernel source, build command, and measurement on H200 (sm_90a, CUDA 12.9).
