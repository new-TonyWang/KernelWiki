...
probed_by: 80-experience/api-probes/2026-04-17-runtime-pipeline-wait-prior.md
...
See the probe record at [80-experience/api-probes/2026-04-17-runtime-pipeline-wait-prior.md](../../80-experience/api-probes/2026-04-17-runtime-pipeline-wait-prior.md) for a complete end-to-end example, kernel source, build command, and measurement on H200 (sm_90a, CUDA 12.9).
