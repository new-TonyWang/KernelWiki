...
probed_by: 80-experience/api-probes/2026-04-16-runtime-ballot-sync.md
...
See [probe record](../../../80-experience/api-probes/2026-04-16-runtime-ballot-sync.md) for a complete end-to-end example: host allocation of random floats, H2D copy, warp ballot + popcount kernel (counting lanes above a threshold), D2H copy, and exact correctness verification. Tested on H200 (sm_90a, CUDA 12.9).
