...
- [80-experience/hw-probes/half2-throughput/2026-04-23-half2-throughput.md](../../../80-experience/hw-probes/half2-throughput/2026-04-23-half2-throughput.md) — 5-variant FMA throughput sweep. Load-bearing results: __hfma2 = 1.16× __hfma (not 2×); bf16-packed = 0.88× fp16-packed (not equal).
