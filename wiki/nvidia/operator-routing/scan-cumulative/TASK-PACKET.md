...
This document defines the operator-specific task packet fields for a scan (prefix sum / cumulative) kernel-writing task. It refines the generic task packet contract in `70-reasoning/task-packet.md` with scan-specific required and optional fields.
...
success_criteria:
  ...
  - performance: "median_latency <= 1.1 * baseline_latency"
references:
  - 20-pattern/cuda-core/scan-cumulative/INDEX.md
  - 20-pattern/cuda-core/scan-cumulative/ROUTING.md
...
1. Read `20-pattern/cuda-core/scan-cumulative/INDEX.md` -- follow the decision tree starting at Step 0.
