...
This document defines the operator-specific task packet fields for a pooling kernel-writing task. It refines the generic task packet contract in `reasoning/task-packet.md` with pooling-specific required and optional fields.
...
success_criteria:
  ...
  - performance: "median_latency <= 1.1 * baseline_latency"
references:
  - wiki/nvidia/operator-routing/cuda-core/pooling/INDEX.md
  - wiki/nvidia/operator-routing/cuda-core/pooling/ROUTING.md
...
1. Read `wiki/nvidia/operator-routing/cuda-core/pooling/INDEX.md` -- follow the decision tree starting at Step 0.
