...
This file lists the optimization skills applicable to custom elementwise kernels, in priority order. Only skills that exist under `wiki/nvidia/foundations/` are referenced.

---

## Priority 1: coalescing (critical)

- **Skill**: `wiki/nvidia/foundations/memory/coalescing/`
...
- **Skill**: `wiki/nvidia/foundations/memory/bank-conflict/`
...
- **Skill**: `wiki/nvidia/foundations/compute/warp-primitives/`
...
- **Skill**: `wiki/nvidia/foundations/memory/layout-transform/`
...
- **Skill**: `wiki/nvidia/foundations/memory/vectorized-access/`
...
- **Skill**: `wiki/nvidia/foundations/compute/warp-divergence/`
...
- **Relevance to bottleneck triage**: Q4 in `reasoning/bottleneck-triage.md` — "Compute-bound elementwise with divergent conditional on hot path."

### Priority 7: Fast Math Intrinsics

- **Skill**: `wiki/nvidia/foundations/compute/fast-math/`
...
- **Skill**: `wiki/nvidia/foundations/compute/ilp/`
...
- **Skill**: `wiki/nvidia/foundations/compute/compiler-hints/`
...
- **Skill**: `wiki/nvidia/foundations/memory/register-pressure/`
...
- **Skill**: `wiki/nvidia/foundations/memory/async-copy/`
...
- **Skill**: `wiki/nvidia/foundations/memory/cache-load-hints/`
...
- **Skill**: `wiki/nvidia/foundations/compute/half-precision-math/`
...
- **Skill**: `wiki/nvidia/foundations/compute/branch-elimination/`
