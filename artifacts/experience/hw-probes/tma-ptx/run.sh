...
./tma_hello | tee profiles/2026-04-28-tma-ptx-hello.run.log

# ncu CSV at TMA load bandwidth counters.
echo "=== ncu counter capture ==="
if command -v ncu >/dev/null 2>&1; then
    ncu --target-processes all --csv \
        --metrics l1tex__m_xbar2l1tex_read_bytes_mem_global_op_tma_ld.sum,\
sm__cycles_active.avg,\
sm__warps_active.avg.pct_of_peak_sustained_active \
        ./tma_hello \
        2>&1 | tee profiles/2026-04-28-tma-ptx-ncu.csv | tail -10
else
...
if command -v compute-sanitizer >/dev/null 2>&1; then
    compute-sanitizer --tool memcheck \
        ./tma_hello \
        2>&1 | tee profiles/2026-04-28-tma-ptx-sanitizer.log | tail -10
else
...
echo "  run log            : profiles/2026-04-28-tma-ptx-hello.run.log"
echo "  ncu CSV            : profiles/2026-04-28-tma-ptx-ncu.csv"
echo "  sanitizer log      : profiles/2026-04-28-tma-ptx-sanitizer.log"
